...
import com.springmvc.date.DateTool;
...
public final class StringUtil {
	 ...
	 * @author maliang
	 */
	public static String substringBetween(String str, String separator1,
			String separator2) {
	...
	public static String getLoanNumber(Date lendTime, String tierCode, int order) {
		...
		String number = DateTool.dateToString(lendTime,
				DateTool.DATE_PATTERN_NUMBER_DAY) + tierCode + str;
		return number;
	}
	 ...
	 */
	public static List<String> getMatchList(String src, String startTag,
			String endTag) {
		if (src == null) {
			return null;
		}
	 ...
	 */
	public static String replaceStringByParamValue(String src,
	 ...
	 *            电话号码
	 */
	public static String appendMobile(String areaCode, String PhoneNo,
			String phoneNoextNo) {
		if (StringUtils.isNotBlank(phoneNoextNo)) {// 公司号码有分机号028- -4576
													// 028-2541-4576 028 4576
													// 2541
			String companyMobile = "";
			companyMobile += ((StringUtils.isBlank(areaCode) ? "" : areaCode
					+ "-")
					+ (StringUtils.isBlank(PhoneNo) ? " " : PhoneNo) + (StringUtils
					.isBlank(phoneNoextNo) ? "" : "-" + phoneNoextNo)).trim();
			if (StringUtils.isNotBlank(companyMobile)
					&& companyMobile.startsWith("-")) {
				companyMobile = companyMobile.substring(1,
						companyMobile.length());
			}
			if (StringUtils.isNotBlank(companyMobile)
					&& companyMobile.endsWith("-")) {
				companyMobile = companyMobile.substring(0,
	...
	public static String getSerialNo() {
		...
		String pre = DateTool.dateToString(DateTool.getCurrentDate(),
				DateTool.DATE_PATTERN_STRING);
	...
	public static String genSign(Map<String, String> params, String secretKey) {
		...
		for (Entry<String, Object> entry : entrys) {
			baseString.append(entry.getKey()).append("=")
		...
		// 使用MD5对待签名串求签
		try {
			return DigestUtils.md5Hex(baseString.toString().getBytes(
					ABUTMENT_CHARSET));
	 ...
	 * 读取数据
	 */
	public static String readRequestData(BufferedReader bufferedReader)
			throws IOException {
	...
	public static String readRequestData(InputStream bufferedReader)
			throws IOException {
