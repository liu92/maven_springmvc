...
import com.springmvc.math.CalculateDoubleUtil;
...
public class DateTool {
	 ...
	 * 日期格式：yyyy年MM月
	 */
	public static final String DATE_PATTERN_YEAR_MONTH = "yyyy年MM月";
	...
	public static void main(String[] args) throws Throwable {
		...
		System.err.println(getBetweenYear(
				DateTool.stringToDate("1988-01-22", DATE_PATTERN_DAY),
				new Date()));
	}
